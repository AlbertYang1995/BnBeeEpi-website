			...
			<div className = "net" >
				<div className="upload-table">				
					<div className="text-wrap">
						...
						&emsp;The following is a sample data file for 8 individuals(4 cases and 4 controls), each genotyped for 10 SNPs. And also you can download this whole file
						</p>
