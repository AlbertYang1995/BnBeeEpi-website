						...
						<div className="left-box">
							...
							<div className="item">
								...
								<div className="box-text">
									...
									<p>
									Chen Yang<sup>#</sup>, Hui Gao<sup>#</sup>, Xuan Yang, Suiyu Huang, Yulong Kan, Jianxiao Liu*. BnBeeEpi: An Approach of Epistasis Mining Based on Bee Colony Algorithm and Bayesian Network, BIBM, 2019
									</p>
								</div>
							</div>
							<div className="item">
